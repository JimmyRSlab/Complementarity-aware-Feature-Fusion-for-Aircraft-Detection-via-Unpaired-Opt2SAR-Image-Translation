...
class CycleGANModel(BaseModel):
    ...
    def __init__(self, opt):
        ...
        self.netG_A = networks.define_G_SFEG(opt.input_nc, opt.output_nc, opt.ngf, opt.netG, opt.norm,
    ...
    def set_input(self, input):
        ...
        self.targets_mask_A = create_targets_mask(self.image_paths, self.real_A.shape, self.real_A.device)

    def forward(self):
        """Run forward pass; called by both functions <optimize_parameters> and <test>."""
        # self.fake_B = self.netG_A(self.real_A)  # G_A(A)
        self.fake_B = self.netG_A(self.real_A, self.targets_mask_A)
